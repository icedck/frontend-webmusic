    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div>
                ...
                <p className={`mt-2 ${currentTheme.textSecondary}`}>Thay đổi mật khẩu để giữ an toàn cho tài khoản của bạn.</p>
            </div>

            <SettingsCard title="Bảo mật" description="Để bảo mật, bạn sẽ được đăng xuất sau khi đổi mật khẩu thành công.">
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                    <div className="relative">
                        <Input label="Mật khẩu hiện tại" icon={Lock} name="currentPassword" type={showPasswords.current ? 'text' : 'password'} value={passwordData.currentPassword} onChange={handlePasswordChange} disabled={passwordLoading} required/>
                    ...
                    <div className="relative">
                        <Input label="Mật khẩu mới" icon={Lock} name="newPassword" type={showPasswords.new ? 'text' : 'password'} value={passwordData.newPassword} onChange={handlePasswordChange} disabled={passwordLoading} required/>
                    ...
                    <div className="relative">
                        <Input label="Xác nhận mật khẩu mới" icon={Lock} name="confirmationPassword" type={showPasswords.confirm ? 'text' : 'password'} value={passwordData.confirmationPassword} onChange={handlePasswordChange} disabled={passwordLoading} required/>
