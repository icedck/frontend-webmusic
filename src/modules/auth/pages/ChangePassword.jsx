...
const ChangePassword = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    if (
      ...
      toast.error("Mật khẩu mới phải có từ 6 đến 32 ký tự!");
      return;
    }
    ...
    try {
      ...
      toast.success(
        "Đổi mật khẩu thành công! Bạn sẽ được đăng xuất sau 3 giây."
      );
      setPasswordData({
        currentPassword: "",
        newPassword: "",
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className={`mt-2 ${currentTheme.textSecondary}`}>
          Thay đổi mật khẩu để giữ an toàn cho tài khoản của bạn.
        </p>
      </div>

      <SettingsCard
        title="Bảo mật"
        description="Để bảo mật, bạn sẽ được đăng xuất sau khi đổi mật khẩu thành công."
      >
        <form onSubmit={handlePasswordSubmit} className="space-y-4">
          <div className="relative">
            ...
            <button
              type="button"
              className={`absolute bottom-3 right-3 ${currentTheme.textSecondary}`}
