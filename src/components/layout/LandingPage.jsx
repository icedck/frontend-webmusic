...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-surface-50 via-primary-50/30 to-accent-50/20 dark:from-surface-900 dark:via-surface-800/50 dark:to-surface-900">
      {/* Enhanced Header */}
      <header className="relative bg-white/80 dark:bg-surface-900/80 backdrop-blur-xl border-b border-surface-200/60 dark:border-surface-700/60 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            {/* Logo */}
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-primary-800 to-primary-900 rounded-2xl blur opacity-20"></div>
                <div className="relative w-12 h-12 bg-gradient-to-br from-primary-800 to-primary-900 rounded-2xl flex items-center justify-center shadow-lg">
              ...
              <div>
                ...
                <div className="text-xs text-surface-500 font-medium tracking-wider">
                  NEXT-GEN MUSIC
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6">
              <button 
                ...
                className="w-10 h-10 rounded-2xl bg-surface-100/80 dark:bg-surface-800/80 hover:bg-surface-200/80 dark:hover:bg-surface-700/80 text-surface-600 dark:text-surface-400 hover:text-surface-900 dark:hover:text-surface-100 transition-all duration-200 flex items-center justify-center border border-surface-200/60 dark:border-surface-700/60 hover:scale-105"
              >
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-primary-500/20 to-accent-500/20 rounded-full blur-3xl"></div>
          <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-sage-500/20 to-accent-500/20 rounded-full blur-2xl"></div>
          <div className="absolute bottom-20 left-1/3 w-40 h-40 bg-gradient-to-br from-primary-500/10 to-accent-500/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-surface-100/80 to-surface-50/80 dark:from-surface-800/80 dark:to-surface-900/80 rounded-full border border-surface-200/60 dark:border-surface-700/60 backdrop-blur-sm">
              ...
              <h1 className={`text-5xl lg:text-7xl font-bold ${currentTheme.text} tracking-tight leading-tight`}>
                Âm nhạc cho
                <br />
                <span className="bg-gradient-to-r from-primary-800 via-primary-900 to-primary-800 dark:from-primary-300 dark:via-primary-100 dark:to-primary-300 bg-clip-text text-transparent">
                  mọi cảm xúc
                </span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              ...
              >
                {/* Background Glow */}
                <div className="absolute inset-0 bg-gradient-to-br from-primary-500/5 via-accent-500/5 to-sage-500/5 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
                
                <div className="relative bg-white/80 dark:bg-surface-900/80 backdrop-blur-xl border border-surface-200/60 dark:border-surface-700/60 rounded-3xl p-8 hover:border-surface-300/80 dark:hover:border-surface-600/80 transition-all duration-500 group-hover:scale-105 shadow-lg shadow-surface-900/5 hover:shadow-xl hover:shadow-surface-900/10">
                  <div className="flex items-start space-x-6">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 bg-gradient-to-br from-primary-800 to-primary-900 dark:from-primary-600 dark:to-primary-700 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                        {feature.icon}
                      </div>
                    </div>
      ...
      <section className="py-24 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 bg-gradient-to-br from-surface-100/50 via-primary-50/30 to-accent-100/50 dark:from-surface-800/50 dark:via-surface-900/30 dark:to-surface-800/50"></div>
        
        <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
          <div className="bg-white/80 dark:bg-surface-900/80 backdrop-blur-xl border border-surface-200/60 dark:border-surface-700/60 rounded-3xl p-12 lg:p-16 shadow-2xl shadow-surface-900/10">
            <h2 className={`text-4xl lg:text-5xl font-bold ${currentTheme.text} mb-6 tracking-tight`}>
      ...
      {/* Footer */}
      <footer className="relative bg-surface-900 dark:bg-surface-950 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <div className="text-xs text-surface-400 font-medium tracking-wider">
                    NEXT-GEN MUSIC
                  </div>
                </div>
              </div>
          ...
          <div className="pt-8 border-t border-surface-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-surface-400 mb-4 md:mb-0">
