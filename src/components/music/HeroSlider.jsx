...
const staticSlides = [
  {
    id: 1,
    // title: "Sự Kiện Âm Nhạc Mùa Hè",
    // description: "Hòa mình vào những giai điệu sôi động nhất",
    imageUrl: "../public/image-heroslide/banner2-9.jpg",
    link: "http://localhost:3000/playlist/9",
  },
  {
    id: 2,
    title: "Top Hits Mới Nhất",
    description: "Khám phá những bản hit đang làm mưa làm gió",
    imageUrl:
