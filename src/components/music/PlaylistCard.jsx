...
const PlaylistCard = ({ playlist, onAddSongs }) => {
    ...
    return (
        <div>
            <Link to={`/playlist/${playlist.id}`} className="block group cursor-pointer">
            ...
            <div className="mt-3">
                <Link to={`/playlist/${playlist.id}`} className="font-semibold truncate hover:underline">{playlist.title}</Link>
